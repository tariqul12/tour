        ...
        <div class="col-lg-12">
            <div class="card rounded-0">
                <div class="border-bottom py-5">
                    <div class="row">
                        <div class="col-6">
                            <h3 class="fw-bold text-end">All banner Info</h3>
                        </div>
                        <div class="col-5 text-end me-1">
                            <a href="{{ route('banner.create') }}" class="btn btn-primary rounded-0">Add New banner</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table id="example3" class="table table-bordered text-nowrap border-bottom">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th class="border-bottom-0">Banner Type</th>
                            ...
                            <tbody>
                                @foreach ($banners as $banner)
                                    <tr class="text-center">
                                        ...
                                        <td><img width="80" src="{{ asset($banner->image) }}" alt=""></td>
