...
@section('body')
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Policy Module</h1>
        </div>
        ...
        <div class="col-lg-12 shadow">
            <div class="card shadow rounded-0">
                ...
                <div class="border-bottom py-5">
                    <div class="row">
                        <div class="col-6">
                            <h3 class="fw-bold text-end"> Policy Form</h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('policy.update', $policy->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" id="summernote" name="description" placeholder="Description">{{ $policy->description }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="radio" class="col-md-3 form-label"></label>
                            <div class="col-md-9">
                                <button class="btn btn-primary rounded-0" type="submit">Update Policy</button>
                            </div>
                        </div>
                    </form>
                </div>
