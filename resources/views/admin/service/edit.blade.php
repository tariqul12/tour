                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{ $service->title }}" id="" name="title"
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <img width="120" class="my-1" src="{{ asset($service->image) }}" id=""
                                    alt="">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="" id="published" name="status"
                                    {{ $service->status == 1 ? 'checked' : '' }} type="radio" value="1"><label
                                    for="published">published</label>
                                <input class="mx-2" id="Unpublished" name="status"
                                    {{ $service->status == 0 ? 'checked' : '' }} type="radio" value="0"><label
                ...
                <div class="card shadow rounded-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <button class="btn btn-primary rounded-0 " style="width: 100%" type="submit">Update
                                    Service</button>
                            </div>
                        </div>
                    </div>
