        ...
        <div class="col-lg-12">
            <div class="card rounded-0">
                <div class="border-bottom py-5">
                    <div class="row">
                        <div class="col-6">
                            <h3 class="fw-bold text-end">All Team Info</h3>
                        </div>
                        <div class="col-5 text-end me-1">
                            <a href="{{ route('team.create') }}" class="btn btn-primary rounded-0">Add New Team</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($teams as $team)
                                    <tr class="text-center">
                                        ...
                                        <td>{{ $team->name }}</td>
                                        <td><img width="80" src="{{ asset($team->image) }}" alt=""></td>
