            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Destination Module</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li><a href="{{ route('destination.create') }}" class="slide-item">Add Destination</a></li>
                        <li><a href="{{ route('destination.index') }}" class="slide-item">Manage Destination</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('gallery.create') }}" class="slide-item">Add Gallery</a></li>
                        <li><a href="{{ route('gallery.index') }}" class="slide-item">Manage Gallery</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Company Module</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
